export default function HeavyDutyHotSectionPage() {
  return (
    <div className="services-heavy-duty-hot-section" style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Hot Section</h1>
      ...
      <ul>
        ...
        <li>Component repair and coating</li>
